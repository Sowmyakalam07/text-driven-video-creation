...
# Define the path to the ImageMagick binary (Windows Only)
# Modify this path to match the location of convert.exe on your system
...
for para in paragraphs[:-1]:
    ...
    try:
        ...
        print(f"Error fetching and executing code: {e}")
    ...
    text_clip = TextClip(para, fontsize=35, color="white", bg_color="black", font="Arial")
    text_clip = text_clip.set_pos(('center','bottom')).set_duration(audio_duration)
